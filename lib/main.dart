...
import 'package:hakubasolotrip/splash_screen/splash_screen_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Stream<HakubasolotripFirebaseUser> userStream;
  HakubasolotripFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = hakubasolotripFirebaseUserStream()
